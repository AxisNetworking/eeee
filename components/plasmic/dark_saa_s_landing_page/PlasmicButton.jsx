...
import sty from "./PlasmicButton.module.css"; // plasmic-import: 8jUqIGC2DEh-/css
    ...
    >
      ...
      {(
        ...
        ? renderPlasmicSlot({
            defaultContents: (
              <svg
                className={classNames(projectcss.all, sty.svg__kobvb)}
                role={"img"}
              />
            ),
      ...
      {(
        ...
        ? renderPlasmicSlot({
            defaultContents: (
              <svg
                className={classNames(projectcss.all, sty.svg__ltq11)}
                role={"img"}
              />
            ),
