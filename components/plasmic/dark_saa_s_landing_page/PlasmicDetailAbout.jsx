...
import sty from "./PlasmicDetailAbout.module.css"; // plasmic-import: NlCcq-oAdX0V/css
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <div className={classNames(projectcss.all, sty.column__fPee8)}>
            <PlasmicImg__
          ...
          <div className={classNames(projectcss.all, sty.column__k7GVa)}>
            <h5
